# TODO: ADJUST maskPos_loss_fn BASED ON PATCHING
...
while num_steps < config.tot_steps:
    ...
    for batch_images, batch_dimensions in train_loader:
        ...
        loss_maskType = (maskPos_loss_fn(pos_out_model1, orig_mask1, pos_mask1) + maskPos_loss_fn(pos_out_model2, orig_mask2, pos_mask2)) / 2
