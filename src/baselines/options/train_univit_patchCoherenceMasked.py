...
while num_steps < config.tot_steps:
    ...
    for batch_images, batch_dimensions in train_loader:
        ...
        loss_coherence = (coherence_loss_fn(embd_seq_model1, mask1, orig_mask1) + coherence_loss_fn(embd_seq_model2, mask2, orig_mask2)) / 2
...
pbar.close()
pickle.dump(loss_plot, open(f'{save_dir}/univit_patchCoherenceMasked_loss_plot.pkl', 'wb'))