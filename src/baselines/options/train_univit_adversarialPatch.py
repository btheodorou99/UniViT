...
while num_steps < config.tot_steps:
    ...
    for batch_images, batch_dimensions in train_loader:
        ...
        cls_model = model.embed(batch_images_aug1, batch_dimensions1, train=True, adversarialPatch=adversarial)
        ...
        adv_cls_model = model.embed(batch_images_aug1, batch_dimensions1, train=True, adversarialPatch=adversarial)
