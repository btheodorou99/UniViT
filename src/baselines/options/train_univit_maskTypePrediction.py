...
while num_steps < config.tot_steps:
    ...
    for batch_images, batch_dimensions in train_loader:
        ...
        embd_seq_model, pos_embd_seq_model, mask, orig_mask = model(batch_images, batch_dimensions, seqMask=True, train=True, posOutput=True)
        with torch.no_grad():
        ...
        loss_maskType = maskType_loss_fn(pos_embd_seq_model, mask, orig_mask)
