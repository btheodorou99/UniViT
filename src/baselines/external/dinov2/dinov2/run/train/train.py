...
from src.baselines.external.dinov2.dinov2.train import get_args_parser as get_train_args_parser
...
class Trainer(object):
    ...
    def __call__(self):
        from src.baselines.external.dinov2.dinov2.train import main as train_main
