...
from src.baselines.external.dinov2.dinov2.eval.knn import get_args_parser as get_knn_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from src.baselines.external.dinov2.dinov2.eval.knn import main as knn_main
