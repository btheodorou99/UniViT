...
def enable(*, set_cuda_current_device: bool = True, overwrite: bool = False, allow_nccl_timeout: bool = False, gpu_num: int = 0):
    ...
    if set_cuda_current_device:
        torch.cuda.set_device('cuda:{}'.format(gpu_num))
