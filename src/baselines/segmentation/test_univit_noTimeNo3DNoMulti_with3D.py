...
from src.baselines.segmentation.data.image_dataset_noTime import ImageDataset

model_key = "univit_noTimeNo3DNoMulti_with3D"
...
for task in valid_tasks:
    ...
    for epoch in tqdm(
        ...
        for batch_images, _, batch_labels in tqdm(
            ...
            with torch.no_grad():
                representations = model.embed_patches(batch_images)
