...
class UniViT(nn.Module):
    def __init__(
        ...
        self.conv_proj = Conv4d(
            in_channels=self.image_channels, out_channels=hidden_dim, kernel_size=(max_time_size, max_slice_size, patch_size, patch_size), stride=(max_time_size, max_slice_size, patch_size, patch_size)
        )
